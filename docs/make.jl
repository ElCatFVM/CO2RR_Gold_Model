...
function make(; with_notebooks = true)
    ...
    makedocs(;
        ...
        draft = false,
        authors = "S.M. Choi",
        repo = "https://github.com/ElCatFVM/Capacitance_Code/Capacitance_Code.jl/",
        pages
    )

    cleanexamples()
    if !isinteractive()
        deploydocs(repo = "github.com/ElCatFVM/Capacitance_Code/Capacitance_Code.jl.git", devbranch = "main")
    end
    return
end
