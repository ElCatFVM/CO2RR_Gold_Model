...
# ╔═╡ d68f2cbd-c3a5-4e0b-9dbd-b9b3e1f3e92d
begin
...
# ╔═╡ 66abc4d9-0995-4f19-88a5-f66b42f0322c
begin
...
# ╔═╡ 2609a5ba-76bb-416c-8b7b-77513f145421
begin
	const bulk = let 
		bulk = [
...
# ╔═╡ 0429e022-d42b-4d95-83c7-f3f32d063b9b
begin
...
# ╔═╡ dfed5d6f-a148-463d-8f90-064f078f62d5
...
# ╔═╡ f83097aa-4673-4f1b-b4c1-47029a6a68b6
begin
...
# ╔═╡ 1e13265a-b160-4686-a297-4dcbfcc2c85d
begin
...
# ╔═╡ 92b38150-add7-4cd1-95f4-d562cc25104f
function halfcellbc(
	f,
	u::VoronoiFVM.BNodeUnknowns{Tval, Tv, Tc, Tp, Ti}, 
	bnode,
...
pbsys=PBSystem(grid;celldata=deepcopy(celldata),halfcellbc)
...
manifest_format = "2.0"
project_hash = "d306df0bc497ab6d4a0d86bf543b1194a760899a"
