...
module Sweeps0
    ...
    function create_model(;
        ...
        return (bcondition = pnp_bcondition, reaction = reaction, elydata = elydata)
    end

    function sweep_IV_DGML_Robin_Gold_hydrated(; voltages = (-1.5:0.1:0.0) * V, kwargs...)
        solver_control = (;
            max_round = 4,
            maxiters = 20,
            tol_round = 1.0e-9,
